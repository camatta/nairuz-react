          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="text-main-case">
                <p>Foi assim que em 2019, a companhia foi adquirida pelo Grupo DM Cards, uma instituição financeira que administra cartões de crédito, com o intuito de abranger a sua área de atuação.</p>
              </div>
            </div>
            <div className="col-12 col-md-6">
              <div className="text-main-case">
