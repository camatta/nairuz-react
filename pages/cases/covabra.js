...
export default function NovaMedicamentos2() {
  return (
    <div className="page-cases page-case-novamed case-covabra">
      <Head>
        <title>92% a mais de faturamento em 12 meses: como o covabra conseguiu aumentar sua receita</title>
        <meta name="description" content="Saiba como a Nairuz desempenhou um papel fundamental na conquista do Covabra Supermercados, aumentando seus acessos orgânicos em 127% em menos de um ano." />
        <meta property="og:image" content="https://nairuz.com.br/og-nairuz.png" />
				<meta property="og:image:type" content="image/png" />
				<meta property="og:image:width" content="600" />
				<meta property="og:image:height" content="400" />
        <meta property="og:description" content="Saiba como a Nairuz desempenhou um papel fundamental na conquista do Covabra Supermercados, aumentando seus acessos orgânicos em 127% em menos de um ano." />
				<meta property="og:site_name" content="92% a mais de faturamento em 12 meses: como o covabra conseguiu aumentar sua receita" />
