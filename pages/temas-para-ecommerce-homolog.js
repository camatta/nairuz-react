            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <a href="https://xd.adobe.com/view/08e5df29-9ded-4f72-bfe2-745b9572510d-5db6/" target="_blank" rel="noopener noreferrer">
                        <Image src="/modelo-gaming.png" alt="Gaming Preview" width={535} height={262} />
                      </a>
                      <div className="efeito-previa">
                        <a href="https://xd.adobe.com/view/08e5df29-9ded-4f72-bfe2-745b9572510d-5db6/?fullscreen" target="_blank" rel="noopener noreferrer">
