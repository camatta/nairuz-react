            ...
            <div className="row">
              <div className="col-12 col-md-5">
                ...
                <div className="buttons-temas">
                  <Link href="#"><a className="saiba-mais-temas">Saiba mais</a></Link>
                  <Link href="#"><a className="consultor-temas" href="#">Falar com um consultor</a></Link>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="col-6">
                <div className="text-apresentacao">
                  ...
                  <div className="buttons-apresentacao">
                    <Link href="#"><a className="saiba-mais-temas">Ver temas</a></Link>
                    <Link href="#"><a className="consultor-apresentacao" href="#">Falar com um consultor</a></Link>
                  </div>
                </div>
              </div>
              <div className="col-6">
            ...
            <div className="row">
                ...
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    ...
                    <div className="logo-modelo">
                      <Image src="/logo-diamond.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
                  </div>
                  <div className="footer-modelo">
                    ...
                    <div className="button-modelo">
                      <button className="btn-modelo">Usar Tema</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="col-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <Image src="/modelo-decora.png" alt="Diamond Preview" width={535} height={262} />
                    </div>
                    <div className="logo-modelo">
                      <Image src="/logo-decora.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
            ...
            <div className="row">
              <div className="col-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <Image src="/modelo-food.png" alt="Diamond Preview" width={535} height={262} />
                    </div>
                    <div className="logo-modelo">
                      <Image src="/logo-food.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
              ...
              <div className="col-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <Image src="/modelo-ruby.png" alt="Diamond Preview" width={535} height={262} />
                    </div>
                    <div className="logo-modelo">
                      <Image src="/logo-ruby.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
            ...
            <div className="row">
              <div className="col-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <Image src="/modelo-athletic.png" alt="Diamond Preview" width={535} height={262} />
                    </div>
                    <div className="logo-modelo">
                      <Image src="/logo-athletic.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
              ...
              <div className="col-6">
                <div className="modelo-tema-card">
                  <div className="header-modelo">
                    <div className="img-modelo">
                      <Image src="/modelo-gaming.png" alt="Diamond Preview" width={535} height={262} />
                    </div>
                    <div className="logo-modelo">
                      <Image src="/logo-gaming.png" alt="Diamond Logo" width={120} height={120} />
                    </div>
                    <div className="icon-modelo">
                      <Image src="/icon-modelo.png" alt="Diamond" width={45} height={45} />
                    </div>
