...
const VagasPopup = () => {
  ...
  function submitFormVaga(e) {
    let inputs = Array.from(document.querySelectorAll("#formularioVaga input"));
    
    e.preventDefault();
    inputs.map((input) => {
      if(!input.classList.contains("button-form-temas")){
        input.value = "";
      }
    })
          ...
          <div className="col-12 col-md-6">
            <div className="right-popup">
              <div className="form-popup">
                    <form id="formularioVaga" onSubmit={(e) => submitFormVaga(e)}>
                      ...
                      <div className="linha-form">
                        ...
                        <div className="form-email">
                          ...
                          <input type="text" className="input-email" name="cidade" id="cidade" placeholder="Digite sua cidade" />
                        </div>
                      </div>
